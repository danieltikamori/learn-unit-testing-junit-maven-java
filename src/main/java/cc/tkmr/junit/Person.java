...
// Define a class named cc.tkmr.junit.Person
public class Person {
    ...
    // Constructor for the cc.tkmr.junit.Person class that takes in a name and date of birth
    ...
    // Override the equals method to compare if two cc.tkmr.junit.Person objects are equal
    @Override
    public boolean equals(Object obj){
        ...
        Person person = (Person) obj; // Cast the object to a cc.tkmr.junit.Person
